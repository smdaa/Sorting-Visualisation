...
void help() {
  std::cout << "Usage : main sorting_algorithm" << std::endl;
  std::cout << "sorting_algorithm : bubble-sort / quick-sort / selection-sort / insertion-sort / merge-sort" << std::endl;
}
...
int main(int argc, char ** argv) {
  ...
  char * sorting_algorithm;

  if (argc == 1) {
    help();
    return 1;
  } else {
    sorting_algorithm = argv[1];
  }
